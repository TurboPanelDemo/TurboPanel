...
class HostingSubscriptionBackup extends Model
{
    ...
    {
        $cronJobCommand = 'turbo-php /usr/local/turbo/web/artisan turbo:create-daily-full-hosting-subscriptions-backup';
    ...
    public function startBackup()
    {
        ...
        $backupStorageRootPath = '/var/lib/turbo/backups/hosting_subscriptions';
