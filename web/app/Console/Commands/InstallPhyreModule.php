...
class InstallTurboModule extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'turbo:install-module {module}';
     ...
     * @var string
     */
    protected $description = 'Install a Turbo module.';
    ...
    {
        $this->info('Installing Turbo module...');
        ...
        $this->info('Turbo module installed successfully.');
    }
}
