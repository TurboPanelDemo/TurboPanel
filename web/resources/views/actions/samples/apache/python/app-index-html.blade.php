...
<html>
<head>
    <title>Turbo Panel - Passenger Python Flask App </title>
...
<main class="flex min-h-screen flex-col items-center justify-between p-24">
    ...
    <div class="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left"><a
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50">Find in-depth information about Turbo Panel features and API.</p>
        </a><a
            href=""
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50">Learn about Turbo Panel in an interactive course with&nbsp;quizzes!</p>
        </a><a
            href=""
            class="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50">Explore starter templates for Turbo.</p></a><a
            href=""
            class="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50 text-balance">
                Instantly deploy your Python Flask site to a shareable URL with Turbo.
            </p>
        </a>
    </div>
</main>
