...
class HSNodeJSTest extends ActionTestCase
{
    ...
    function testCreate()
    {
        ...
        $callCustomerStoreResponse = $this->callApiAuthorizedRouteAction(
            'api.customers.store',
            [
                'name' => 'Turbo Unit Test #'.$randId,
                'email' => 'unit-test-'.$randId.'@turbo.com',
            ]
        )->json();
        ...
        $createHostingPlan->name = 'Turbo Unit Test #'.$randId;
        ...
        $hostingSubscriptionDomain = 'turbo-unit-test-'.$randId.'.com';
...
//
//        $this->assertTrue(Str::contains($indexPageContent,'Turbo Panel - PHP App'));
