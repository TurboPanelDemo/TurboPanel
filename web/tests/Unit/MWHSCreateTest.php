...
class MWHSCreateTest extends ActionTestCase
{
    function testCreateInstallation()
    {
        ...
        Artisan::call('turbo:install-module Microweber');
        ...
        $callCustomerStoreResponse = $this->callApiAuthorizedRouteAction('api.customers.store',[
            'name' => 'Turbo Unit Test Microweber Customer',
            'email' => 'turbo-unit-test-microweber-'.rand(1000, 9999).'@turbo.com',
        ])->json();
        ...
        $hostingSubscriptionDomain = 'turbo-unit-test-microweber-'.rand(1000, 9999).'.com';
